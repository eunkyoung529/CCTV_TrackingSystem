...
### 실행 화면
![처음 기본 화면](./docs/streamlit_1.png)
![차량 정보 입력](./docs/streamlit_2.png)
![영상 업로드](./docs/streamlit_3.png)
![영상 탐색 완료](./docs/streamlit_5.png)
![탐색 결과](./docs/streamlit_6.png)
![탐색 결과 등급](./docs/streamlit_7.png)
![세부 일치율](./docs/streamlit_8.png)
